...
describe('Espece Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'espece', component: EspeceComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.especes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
