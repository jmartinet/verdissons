...
public class GenreResource {
    ...
    public ResponseEntity<GenreDTO> updateGenre(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, genreDTO.getId().toString()))
            .body(result);
    }
     ...
     */
    @GetMapping("/genres")
    public List<GenreDTO> getAllGenres(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
