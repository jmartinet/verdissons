...
/**
 * Criteria class for the {@link fr.tos.perma.web.domain.Espece} entity. This
 * class is used in {@link fr.tos.perma.web.web.rest.EspeceResource} to receive
...
public class EspeceCriteria implements Serializable, Criteria {
	...
	public String toString() {
		return "EspeceCriteria{" + (id != null ? "id=" + id + ", " : "")
